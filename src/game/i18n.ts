...
const EN = {
  ...
  topNormal: "Stage Clear (Normal): {t}",
  topNormalStar: "Stage Clear (Normal, Star Mode Activated): {t}",
  ...
  hard4: "Win a round to revive 1 buried Maltese (max 3)",
  reviveHint: "A Maltese revived!",
  easy: "Easy",
  back: "Back",
  vsFriendLead:
